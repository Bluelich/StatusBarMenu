...
{
	self = [super init];
	self.country = [aDecoder decodeObjectForKey:kWeatherSyCountry];
	self.idField = [[aDecoder decodeObjectForKey:kWeatherSyIdField] integerValue];
	self.message = [[aDecoder decodeObjectForKey:kWeatherSyMessage] floatValue];
	self.sunrise = [[aDecoder decodeObjectForKey:kWeatherSySunrise] integerValue];
	self.sunset = [[aDecoder decodeObjectForKey:kWeatherSySunset] integerValue];
	self.type = [[aDecoder decodeObjectForKey:kWeatherSyType] integerValue];
	return self;

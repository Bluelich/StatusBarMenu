...
{
	self = [super init];
	self.humidity = [[aDecoder decodeObjectForKey:kWeatherMainHumidity] integerValue];
	self.pressure = [[aDecoder decodeObjectForKey:kWeatherMainPressure] integerValue];
	self.temp = [[aDecoder decodeObjectForKey:kWeatherMainTemp] floatValue];
	self.tempMax = [[aDecoder decodeObjectForKey:kWeatherMainTempMax] integerValue];
	self.tempMin = [[aDecoder decodeObjectForKey:kWeatherMainTempMin] floatValue];
	return self;

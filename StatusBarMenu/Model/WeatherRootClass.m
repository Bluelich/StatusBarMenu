...
- (void)encodeWithCoder:(NSCoder *)aCoder
{
	...
	[aCoder encodeObject:@(self.cod) forKey:kWeatherRootClassCod];	if(self.coord != nil){
		[aCoder encodeObject:self.coord forKey:kWeatherRootClassCoord];
	}
	[aCoder encodeObject:@(self.dt) forKey:kWeatherRootClassDt];	[aCoder encodeObject:@(self.idField) forKey:kWeatherRootClassIdField];	if(self.main != nil){
	...
	[aCoder encodeObject:@(self.visibility) forKey:kWeatherRootClassVisibility];	if(self.weather != nil){
...
{
	self = [super init];
	self.base = [aDecoder decodeObjectForKey:kWeatherRootClassBase];
	self.clouds = [aDecoder decodeObjectForKey:kWeatherRootClassClouds];
	self.cod = [[aDecoder decodeObjectForKey:kWeatherRootClassCod] integerValue];
	self.coord = [aDecoder decodeObjectForKey:kWeatherRootClassCoord];
	self.dt = [[aDecoder decodeObjectForKey:kWeatherRootClassDt] integerValue];
	self.idField = [[aDecoder decodeObjectForKey:kWeatherRootClassIdField] integerValue];
	self.main = [aDecoder decodeObjectForKey:kWeatherRootClassMain];
	self.name = [aDecoder decodeObjectForKey:kWeatherRootClassName];
	self.sys = [aDecoder decodeObjectForKey:kWeatherRootClassSys];
	self.visibility = [[aDecoder decodeObjectForKey:kWeatherRootClassVisibility] integerValue];
	self.weather = [aDecoder decodeObjectForKey:kWeatherRootClassWeather];
	self.wind = [aDecoder decodeObjectForKey:kWeatherRootClassWind];
	return self;
